...
- Full command reference and flags: `cli.md`
- Credential setup and autoload behavior: `provider-credentials.md`, `configuration.md`
- `.rllm` structure generated by onboarding: `rllm-spec.md`
- Post-generation troubleshooting: `errors.md`
